...
"""
@Project ：吉林大学 
@File    :ablation_baseline.py
@IDE     ：PyCharm 
@Author  ：崔俊贤
@Date    ：2024/5/21 14:25 
"""
import sys
...
from model.MyNet.net_component_ablation_baseline import BasicConv, Encoder_Block, Differ_Enhance, Decoder_Block
...
net = MyCDNet()
T1 = torch.randn(8,3,256,256).cuda()
T2 = torch.randn(8,3,256,256).cuda()
flops,params = profile(model=net.cuda(),inputs=(T1,T2))
print(params/1e6)