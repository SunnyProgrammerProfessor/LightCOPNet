...
from model.MyNet.net_component_ablation_onlyDMCConv import BasicConv, Encoder_Block, Differ_Enhance, Decoder_Block
...
# f,p = profile(model=net.to("cuda:2"),inputs=(T1,T2))
# print(p/1e6)