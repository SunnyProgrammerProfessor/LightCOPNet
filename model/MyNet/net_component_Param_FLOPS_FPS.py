...
class Encoder_Block(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.conv1 = BasicConv(in_channels=out_channels,out_channels=out_channels)
        self.conv2 = BasicConv(in_channels=out_channels,out_channels=out_channels)
