...
from datasets.datasets_config_DSIFN import CDDataset
from torch.utils.data import DataLoader
from model.run_net_DSIFN import train_model
import warnings

# 这里需要自定义数据增强函数
# train_augmentation = MyCDDataAugmentation(256, True, True, True, True, True, True)
# test_augmentation = MyCDDataAugmentation(1024)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--image_path", type=str, default="/home/data/b532zhaoxiaohui/shuaige/ChangeDetection/DSIFN/list",
    ...
    parser.add_argument("--checkpoint_root", default="/home/data/b532zhaoxiaohui/shuaige/ChangeDetection/checkpoints/MyNet/DSIFN_", type=str)
    parser.add_argument("--vis_root", default="/home/data/b532zhaoxiaohui/shuaige/ChangeDetection/vis/MyNet/DSIFN_", type=str)
    ...
    val_dataset = CDDataset(path=args.image_path, form=args.train_val, img_size=args.image_size,
                            transform=args.is_transform,
                            is_train=True)
    val_dataloader = DataLoader(dataset=val_dataset, batch_size=args.batch_size, num_workers=4,
                                shuffle=False)
    dataloaders = {"train": train_dataloader, "val": val_dataloader}

    writer = SummaryWriter("/home/data/b532zhaoxiaohui/shuaige/ChangeDetection/logs/MyNet/DSIFN_")
