...
"""
@Project ：吉林大学 
@File    ：train_ablation_DMCConv.py
@IDE     ：PyCharm 
@Author  ：崔俊贤
@Date    ：2024/5/2 16:47 
"""
...
from model.run_net_ablation_DMCConv import train_model
import warnings
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument("--checkpoint_root", default="/home/data/b532zhaoxiaohui/shuaige/ChangeDetection/checkpoints/MyNet/forth", type=str)
    parser.add_argument("--vis_root", default="/home/data/b532zhaoxiaohui/shuaige/ChangeDetection/vis/MyNet/forth", type=str)
    ...
    writer = SummaryWriter("/home/data/b532zhaoxiaohui/shuaige/ChangeDetection/logs/MyNet/forth")
