...
from model.run_net_ablation_onlyDMCConv import train_model
import warnings
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument("--checkpoint_root", default="/home/data/b532zhaoxiaohui/shuaige/ChangeDetection/checkpoints/MyNet/onlyDMCConv", type=str)
    parser.add_argument("--vis_root", default="/home/data/b532zhaoxiaohui/shuaige/ChangeDetection/vis/MyNet/onlyDMCConv", type=str)
    ...
    writer = SummaryWriter("/home/data/b532zhaoxiaohui/shuaige/ChangeDetection/logs/MyNet/onlyDMCConv")
