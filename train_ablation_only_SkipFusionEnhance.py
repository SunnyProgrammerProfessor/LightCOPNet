...
"""
@Project ：吉林大学 
@File    ：train_ablation_only_DMCConv.py
@IDE     ：PyCharm 
@Author  ：崔俊贤
@Date    ：2024/5/20 18:26 
"""
import torch
import os
import sys
...
from model.run_net_ablation_onlySkipFusionEnhance import train_model
import warnings
"""
    消融实验: Depth Multiscale Cyclic Convolution
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument("--checkpoint_root", default="/home/data/b532zhaoxiaohui/shuaige/ChangeDetection/checkpoints/MyNet/onlySkipFusionEnhance", type=str)
    parser.add_argument("--vis_root", default="/home/data/b532zhaoxiaohui/shuaige/ChangeDetection/vis/MyNet/onlySkipFusionEnhance", type=str)
    ...
    writer = SummaryWriter("/home/data/b532zhaoxiaohui/shuaige/ChangeDetection/logs/MyNet/onlySkipFusionEnhance")
