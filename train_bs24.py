...
from model.run_bs24 import train_model
import warnings
...
if __name__ == '__main__':
    ...
    parser.add_argument("--checkpoint_root", default="/home/data/b532zhaoxiaohui/shuaige/ChangeDetection/checkpoints/MyNet/forth_extra", type=str)
    parser.add_argument("--vis_root", default="/home/data/b532zhaoxiaohui/shuaige/ChangeDetection/vis/MyNet/forth_extra", type=str)
    ...
    writer = SummaryWriter("/home/data/b532zhaoxiaohui/shuaige/ChangeDetection/logs/MyNet/forth_extra")
